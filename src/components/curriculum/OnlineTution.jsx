...
function OnlineTution({ curriculumId }) {
  const tutorsData = {
    "1": "Certified provincial educators and graduates from leading Canadian universities, trained in differentiated assessment and university-level standards.",
    "2": "IB examiners and top-scoring graduates trained through official IB workshops, specializing in IAs, EEs, and TOK essays with criterion-specific insight.",
    "3": "Trained within the SABIS academic system and familiar with assessment modules; several hold AP teaching credentials for dual preparation.",
    "4": "Cambridge-certified educators and former A* achievers trained in examiner report interpretation and past-paper calibration.",
    "5": "Bilingual specialists and examiners trained in Paper 1–4 assessment patterns who provide targeted English and Cantonese explanations.",
    "6": "Experienced educators and IIT/DU graduates trained in NCERT-to-board mapping, emphasizing reasoning and clarity over memorization."
  };

  const tutorInfo = tutorsData[curriculumId] || tutorsData["4"];
    ...
    <>
      ...
      >
        ...
        <Stack spacing={3} maxWidth={["100%", "100%", "50%", "40%"]}>
          ...
          {/* heading  */}
          <Typography fontSize={[25, 28, 30, 35, 40]} fontWeight={600}>
            Our Tutors
          </Typography>
        ...
        {/* right section image  */}
        <Stack
          minWidth={["45%", "40%", "45%", "43%"]}
          maxWidth={["45%", "40%", "45%", "43%"]}
          sx={{
            display: { xs: "none", sm: "none", md: "flex" }, // hide <900px, show >=900px
          }}
        >
          <img
            src="/images/onlineTution.png"
            alt="OnlineTution img"
            height={450}
            width="100%"
          />
        </Stack>
