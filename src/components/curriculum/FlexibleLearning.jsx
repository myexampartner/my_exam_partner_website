...
function FlexibleLearning({ curriculumId }) {
  const edgeData = {
    "1": [
  ...
  const edgePoints = edgeData[curriculumId] || edgeData["4"];
  ...
  return (
    <>
      ...
      >
        ...
        >
          <img
            src="/images/flexibleLearning.png"
            alt="FlexibleLearning img"
            height={450}
            width="100%"
          />
        </Stack>
